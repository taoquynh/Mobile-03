    ...
    func setupData(){
        sections = [
            Section(title: "Calendar",
                    menu: [
                        Menu(title: "Calendar Basic", identifier: "CalendarBasicViewController"),
                        Menu(title: "Custom Calendar", identifier: "CustomCalendarViewController"),
                        Menu(title: "DemoLayoutCalendar", identifier: "DemoCalendarViewController")
                        ])
        ]
    }
}
